...
SECRET_KEY = 'django-insecure-b3a3_dfw&1)z3t=j7883^9e!d7*#imrum+knbd*6kn=zv@jq2i'
ALPHA_VANTAGE_API_KEY = '6CX7O4FR7Y2V1BQB'
...
# Login settings
LOGIN_URL = 'login'  # URL name where login view is located
